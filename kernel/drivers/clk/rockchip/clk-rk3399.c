...
PNAME(mux_armcflux_p)				= { "clk_core_l_lpll_src",
						    "clk_core_l_bpll_src",
						    "clk_core_l_dpll_src",
						    "clk_core_l_gpll_src" };
...
static const struct rockchip_cpuclk_reg_data rk3399_cpucflux_data = {
...
#define RK3399_CPUCFLUX_RATE(_prate, _aclkm, _atclk, _pdbg)		\
	{								\
		.prate = _prate##U,					\
		.divs = {						\
...
static struct rockchip_cpuclk_rate_table rk3399_cpucflux_rates[] __initdata = {
	RK3399_CPUCFLUX_RATE(1800000000, 1, 8, 8),
	RK3399_CPUCFLUX_RATE(1704000000, 1, 8, 8),
	RK3399_CPUCFLUX_RATE(1608000000, 1, 7, 7),
	RK3399_CPUCFLUX_RATE(1512000000, 1, 7, 7),
	RK3399_CPUCFLUX_RATE(1488000000, 1, 6, 6),
	RK3399_CPUCFLUX_RATE(1416000000, 1, 6, 6),
	RK3399_CPUCFLUX_RATE(1200000000, 1, 5, 5),
	RK3399_CPUCFLUX_RATE(1008000000, 1, 5, 5),
	RK3399_CPUCFLUX_RATE( 816000000, 1, 4, 4),
	RK3399_CPUCFLUX_RATE( 696000000, 1, 3, 3),
	RK3399_CPUCFLUX_RATE( 600000000, 1, 3, 3),
	RK3399_CPUCFLUX_RATE( 408000000, 1, 2, 2),
	RK3399_CPUCFLUX_RATE( 312000000, 1, 1, 1),
	RK3399_CPUCFLUX_RATE( 216000000, 1, 1, 1),
	RK3399_CPUCFLUX_RATE(  96000000, 1, 1, 1),
};
...
static void __init rk3399_clk_init(struct device_node *np)
{
	...
	rockchip_clk_register_armclk(ctx, ARMCLKL, "armclkl",
			mux_armcflux_p, ARRAY_SIZE(mux_armcflux_p),
			&rk3399_cpucflux_data, rk3399_cpucflux_rates,
			ARRAY_SIZE(rk3399_cpucflux_rates));
