...
PNAME(mux_armcflux_p)		= { "aplll_core", "gplll_core" };
...
static const struct rockchip_cpuclk_reg_data rk3368_cpucflux_data = {
...
#define RK3368_CPUCFLUX_RATE(_prate, _aclkm, _atclk, _pdbg)		\
	{								\
		.prate = _prate,					\
		.divs = {						\
...
static struct rockchip_cpuclk_rate_table rk3368_cpucflux_rates[] __initdata = {
	RK3368_CPUCFLUX_RATE(1512000000, 1, 6, 6),
	RK3368_CPUCFLUX_RATE(1488000000, 1, 5, 5),
	RK3368_CPUCFLUX_RATE(1416000000, 1, 5, 5),
	RK3368_CPUCFLUX_RATE(1200000000, 1, 4, 4),
	RK3368_CPUCFLUX_RATE(1008000000, 1, 4, 4),
	RK3368_CPUCFLUX_RATE( 816000000, 1, 3, 3),
	RK3368_CPUCFLUX_RATE( 696000000, 1, 2, 2),
	RK3368_CPUCFLUX_RATE( 600000000, 1, 2, 2),
	RK3368_CPUCFLUX_RATE( 408000000, 1, 1, 1),
	RK3368_CPUCFLUX_RATE( 312000000, 1, 1, 1),
};
...
static void __init rk3368_clk_init(struct device_node *np)
{
	...
	rockchip_clk_register_armclk(ctx, ARMCLKL, "armclkl",
			...
			&rk3368_cpucflux_data, rk3368_cpucflux_rates,
			ARRAY_SIZE(rk3368_cpucflux_rates));
