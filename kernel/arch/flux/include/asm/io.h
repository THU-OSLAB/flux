#ifndef _ASM_FLUX_IO_H
#define _ASM_FLUX_IO_H
...
static inline u8 __raw_readb(const volatile void __iomem *addr)
{
	...
	ret = flux_ops_iomem_access(addr, &value, sizeof(value), 0);
...
static inline void __raw_writeb(u8 value, volatile void __iomem *addr)
{
	...
	ret = flux_ops_iomem_access(addr, &value, sizeof(value), 1);
