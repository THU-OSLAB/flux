...
static int __init chacha_simd_mod_init(void)
{
	...
	pr_info("chacha: using %s SIMD\n",
		static_branch_unlikely(&chacha_use_avx512vl) ? "AVX512" :
		static_branch_unlikely(&chacha_use_avx2)     ? "AVX2" :
		static_branch_unlikely(&chacha_use_simd)     ? "SSSE3" :
							       "generic");
